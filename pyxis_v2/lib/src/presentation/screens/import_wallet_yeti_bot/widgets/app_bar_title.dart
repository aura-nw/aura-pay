...
class ImportWalletYetiBotAppBarTitleWidget extends StatelessWidget {
  final AppLocalizationManager localization;
  final AppTheme appTheme;

  const ImportWalletYetiBotAppBarTitleWidget({
      ...
      children: [
        ...
        Text(
          localization.translate(
            LanguageKey.importWalletYetiBotScreenYetiBot,
          ),
