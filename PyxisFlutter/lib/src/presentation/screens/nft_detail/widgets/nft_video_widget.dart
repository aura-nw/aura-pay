...
class NFTVideoWidget extends StatefulWidget {
  final String thumbUrl;
  final String? source;
  final AppTheme appTheme;

  const NFTVideoWidget({
    Key? key,
    this.source,
  ...
  @override
  State<NFTVideoWidget> createState() => NFTVideoWidgetState();
}

class NFTVideoWidgetState extends State<NFTVideoWidget> {
  ...
  @override
  void didUpdateWidget(covariant NFTVideoWidget oldWidget) {
