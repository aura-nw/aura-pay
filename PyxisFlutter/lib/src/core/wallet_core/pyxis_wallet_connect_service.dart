...
class PyxisWalletConnectService {
  ...
  Future<void> create({
    ...
    _registerChain('cosmos:euphoria-2', _web3Wallet!);
    _registerChain('cosmos:cosmoshub-4', _web3Wallet!);
    _registerChain('cosmos:xstaxy-1', _web3Wallet!);
  ...
  void registerChain(String chainId) {
    _registerChain(chainId, _web3Wallet!);
  }
  ...
  static _registerChain(String chainId, Web3Wallet web3wallet) {
