...
import 'package:aurapay/src/application/provider/local/account/account_database_service_impl.dart';
import 'package:aurapay/src/application/provider/local/balance/balance_database_service_impl.dart';
import 'package:aurapay/src/application/provider/local/key_store/key_store_database_service_impl.dart';
import 'package:aurapay/src/application/provider/local/localization_service_impl.dart';
import 'package:aurapay/src/application/provider/local/normal_storage_service_impl.dart';
import 'package:aurapay/src/application/provider/local/secure_storage_service_impl.dart';
import 'package:aurapay/src/application/provider/local/token/token_database_service_impl.dart';
import 'package:aurapay/src/application/provider/local/token_market/token_market_database_service_impl.dart';
import 'package:aurapay/src/application/provider/provider/biometric_provider.dart';
import 'package:aurapay/src/application/provider/provider/web3_auth_provider.dart';
import 'package:aurapay/src/application/provider/service/balance/balance_service_impl.dart';
import 'package:aurapay/src/application/provider/service/nft/nft_service_impl.dart';
import 'package:aurapay/src/application/provider/service/token_market/remote_token_market_service_impl.dart';
import 'package:aurapay/src/core/constants/app_local_constant.dart';
import 'package:aurapay/src/core/constants/network.dart';
import 'package:aurapay/src/core/observer/home_page_observer.dart';
import 'package:aurapay/src/presentation/screens/confirm_send/confirm_send_bloc.dart';
import 'package:aurapay/src/presentation/screens/create_passcode/create_passcode_cubit.dart';
import 'package:aurapay/src/presentation/screens/generate_wallet/generate_wallet_cubit.dart';
import 'package:aurapay/src/presentation/screens/get_started/get_started_cubit.dart';
import 'package:aurapay/src/presentation/screens/home/home/home_page_bloc.dart';
import 'package:aurapay/src/presentation/screens/home/home_bloc.dart';
import 'package:aurapay/src/presentation/screens/import_wallet/import_wallet_bloc.dart';
import 'package:aurapay/src/presentation/screens/import_wallet_yeti_bot/import_wallet_yeti_bot_cubit.dart';
import 'package:aurapay/src/presentation/screens/manage_token/manage_token_bloc.dart';
import 'package:aurapay/src/presentation/screens/re_login/re_login_cubit.dart';
import 'package:aurapay/src/presentation/screens/send/send_bloc.dart';
