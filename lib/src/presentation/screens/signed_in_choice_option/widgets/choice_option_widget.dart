                  ...
                  children: [
                    ...
                    if (isRecommended) ...[
                      ...
                      Container(
                        ...
                        child: Text(
                          localization.translate(
                            LanguageKey.signedInChoiceOptionScreenRecommended,
                          ),
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        _ChoiceOptionWidget(
          theme: appTheme,
          content: LanguageKey.signedInChoiceOptionScreenSmartAccountOptionContent,
          subContent: LanguageKey.signedInChoiceOptionScreenSmartAccountOptionMore,
          title: LanguageKey.signedInChoiceOptionScreenSmartAccountOption,
        ...
        _ChoiceOptionWidget(
          theme: appTheme,
          content: LanguageKey.signedInChoiceOptionScreenNormalWalletOptionContent,
          subContent: LanguageKey.signedInChoiceOptionScreenNormalWalletOptionMore,
          title: LanguageKey.signedInChoiceOptionScreenNormalWalletOption,
