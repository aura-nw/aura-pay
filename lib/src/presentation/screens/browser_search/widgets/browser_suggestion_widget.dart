...
abstract class BrowserSuggestionWidget extends StatelessWidget {
  final String name;
...
class BrowserEcosystemSuggestionWidget extends BrowserSuggestionWidget {
  final String logo;
  const BrowserEcosystemSuggestionWidget({
    super.key,
    required super.name,
