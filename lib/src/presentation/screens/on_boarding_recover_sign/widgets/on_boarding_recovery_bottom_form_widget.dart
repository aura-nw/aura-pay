...
import 'on_boarding_recovery_account_form_widget.dart';
import 'package:pyxis_mobile/src/presentation/widgets/app_button.dart';
import 'package:pyxis_mobile/src/presentation/widgets/divider_widget.dart';

class OnBoardingRecoveryBottomFormWidget extends StatelessWidget {
  ...
  const OnBoardingRecoveryBottomFormWidget({
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        OnBoardingRecoveryAccountFormWidget(
          appTheme: appTheme,
          address: address,
          ...
          builder: (localization, _) {
            return PrimaryAppButton(
              text: localization.translate(
                LanguageKey.onBoardingRecoverSignScreenConfirmButtonTitle,
              ),
              onPress: onConfirm,
            );
          },
