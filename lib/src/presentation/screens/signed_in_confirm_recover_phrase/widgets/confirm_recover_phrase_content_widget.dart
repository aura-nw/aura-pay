                ...
                children: [
                  TextSpan(
                    text: localization.translate(
                      LanguageKey
                          .signedInConfirmRecoveryPhraseScreenContentRegionOne,
                    ),
                  ),
                  TextSpan(
                    text: ' ${localization.translate(
                      LanguageKey
                          .signedInConfirmRecoveryPhraseScreenContentRegionTwo,
                    )} ',
                  ...
                  TextSpan(
                    text: localization.translate(
                      LanguageKey
                          .signedInConfirmRecoveryPhraseScreenContentRegionThree,
                    ),
                  ),
                  TextSpan(
                    text: ' ${localization.translateWithParam(
                      LanguageKey
                          .signedInConfirmRecoveryPhraseScreenContentRegionFour,
                      {'words': '4 , 5, 6'},
                    )} ',
                    style: AppTypoGraPhy.bodyMedium03.copyWith(
                      color: appTheme.contentColorBlack,
                  ...
                  TextSpan(
                    text: localization.translate(
                      LanguageKey
                          .signedInConfirmRecoveryPhraseScreenContentRegionFive,
                    ),
                  ),
                ],
              ),
          ...
          builder: (localization, _) {
            return TextInputNormalWidget(
              ...
              hintText: localization.translateWithParam(
                LanguageKey.signedInConfirmRecoveryPhraseScreenHint,
                {'words': '4 , 5, 6'},
              ),
              onChanged: (_, isValid) {
              ...
              constraintManager: ConstraintManager()
                ..custom(
                  errorMessage: localization.translate(
                    LanguageKey
                        .signedInConfirmRecoveryPhraseScreenIncorrectAnswer,
                  ),
          ...
          builder: (localization, _) {
            return Text(
              localization.translate(
                LanguageKey.signedInConfirmRecoveryPhraseScreenEg,
              ),
                    ...
                    children: [
                      AppLocalizationProvider(
                        builder: (localization, _) {
                          return Text(
                            localization.translate(
                              LanguageKey.signedInConfirmRecoveryPhraseScreenDtn,
                            ),
            ...
            AppLocalizationProvider(
              builder: (localization, _) {
                return Text(
                  localization.translate(
                    LanguageKey
                        .signedInConfirmRecoveryPhraseScreenNameYourWallet,
                  ),
          ...
          builder: (localization, _) {
            return TextInputNormalWidget(
              ...
              hintText: localization.translate(
                LanguageKey.signedInConfirmRecoveryPhraseScreenNameYourWallet,
              ),
