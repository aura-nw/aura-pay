...
/// Halo trade
const BookMark haloTradeDev = BookMark(
  id: -1,
...
/// Seek hype
const BookMark seekHypeDev = BookMark(
  id: -2,
...
/// Pyxis safe
const BookMark pyxisSafeDev = BookMark(
  id: -3,
...
/// Aura scan
const BookMark auraScanDev = BookMark(
  id: -4,
  logo: 'https://explorer.dev.aura.network/assets/images/logo/title-logo.png',
  name: 'Aurascan',
